...
Pages['director-dashboard'] = {
  ...
  _switchTab(tab) {
    ...
    const titles = { home: 'Dashboard', members: 'Members', passes: 'Gate Passes', reports: 'Reports', settings: 'Settings' };
    ...
    try {
      ...
      body.innerHTML = `
        <div style="text-align:center;margin-bottom:16px;">
          ...
          <p style="font-size:11px;color:var(--bgi-text-secondary);">${UI.escapeHtml(user.campus || '')}</p>
        </div>
